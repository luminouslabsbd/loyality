            ...
            <div class="px-4 pb-4 @if($hasTabs) pt-1 sm:rounded-b-lg @endif">
                ...
                <x-forms.form-open
                    ...
                    <div class="flex flex-col items-center justify-evenly space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
                        <button type="submit" class="w-full rounded-lg btn-lg" style="background: #2963FF; color: white;" onmouseover="this.style.background='blue';" onmouseout="this.style.background='#2963FF';">{{ trans('common.save_changes') }}<span
