                ...
                <div class="w-full space-y-4 md:space-y-6 max-w-lg xl:max-w-lg p-6">
                    ...
                    <p class="text-sm font-light text-gray-500 dark:text-gray-300">
                        {{ trans('common.registration_text') }} <a href="{{ route('member.register') }}"
                            class="text-link" style="color: #2963FF">{{ trans('common.registration_link') }}</a>
                    </p>
                </div>
            </div>
            <div class="flex justify-center items-center py-6 px-4 g:py-0 sm:px-0" style="background: #2963FF">
