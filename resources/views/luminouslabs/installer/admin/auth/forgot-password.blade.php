        ...
        <div class="grid lg:grid-cols-2 lg:h-full">
            ...
            <div class="ll-login-right flex justify-center items-center py-6 px-4 lg:py-6 sm:px-0">
                <div class="w-full space-y-4 md:space-y-6 max-w-lg xl:max-w-lg p-6">
                    ...
                    <x-forms.form-open class="ll-form-container space-y-4 md:space-y-6" :action="route('admin.forgot_password.post')" method="POST" />
                        <x-forms.input type="email" name="email" :label="trans('common.email_address')" :placeholder="trans('common.your_email')"
                            :required="true" />
