...
@section('content')
    <section class="w-full place-self-center mx-auto partner-login-page lg:h-full ll-login-container">
        <div class="grid lg:grid-cols-2 lg:h-full">
            ...
            <div class="ll-login-right flex justify-center items-center py-6 px-4 lg:py-6 sm:px-0">
                <div class="w-full space-y-4 md:space-y-6 max-w-lg xl:max-w-lg p-6">
                    ...
                    <x-forms.form-open class="ll-form-container space-y-4 md:space-y-6" :action="route('partner.login.post')" method="POST" />
                    <x-forms.input
