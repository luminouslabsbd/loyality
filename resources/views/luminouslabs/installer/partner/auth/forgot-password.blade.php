...
@section('content')
    <section class="w-full place-self-center mx-auto lg:h-full partner-forgot-page ll-login-container">
            ...
            <div class="ll-login-right flex justify-center items-center py-6 px-4 lg:py-6 sm:px-0">
                <div class="w-full space-y-4 md:space-y-6 max-w-lg xl:max-w-lg p-6">
                    ...
                    @if (!Session::has('success'))
                        <x-forms.form-open class="ll-form-container space-y-4 md:space-y-6" :action="route('partner.forgot_password.post')" method="POST" />
