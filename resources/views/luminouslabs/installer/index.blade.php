            ...
            <div class="overflow-x-auto">
                <form method="POST" id="formDataDefinition">
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400" id="tableDataDefinition">
                        ...
                        <tbody>
                            @foreach ($campainData as $key => $data)
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100 bg-white dark:bg-gray-800 dark:hover:bg-gray-900/50"
                                    :class="selected[0] ? 'bg-gray-200 hover:bg-gray-200 dark:bg-gray-900 dark:hover:bg-800' :
                                        'bg-white dark:bg-gray-800 dark:hover:bg-gray-900/50'">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex flex-nowrap justify-end space-x-2">
                                            <div data-tooltip-target="results-tooltip" data-tooltip-placement="top"
                                                class="null">
                                                <a href="{{ route('luminouslabs::partner.campain.view', $data->id) }}"
                                                    data-fb="tooltip"
                                                    class="ll-action-btn ll-primary whitespace-nowrap items-center flex px-2 py-2 text-xs border focus:outline-none font-medium rounded text-center">
                                            ...
                                            <div data-tooltip-target="results-tooltip-1701717886709"
                                                ...
                                                <a href="{{ route('luminouslabs::partner.campain.edit', $data->id) }}"
                                                    data-fb="tooltip"
                                                    ...
                                                    <svg class="h-3.5 w-3.52" xmlns="http://www.w3.org/2000/svg"
                                                        fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                                        stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
