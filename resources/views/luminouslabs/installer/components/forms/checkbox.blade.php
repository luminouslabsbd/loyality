<div class="{{ $class }}">
    <div class="flex items-center">
        ...
        <input
            class="w-4 h-4 bg-gray-100 rounded border-gray-300  focus:ring-blue-100 dark:focus:ring-primary-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 @error($name) is-invalid @enderror"
            style="color: #2963FF;"
