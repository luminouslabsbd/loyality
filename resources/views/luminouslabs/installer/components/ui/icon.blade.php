@if ($icon == 'sun')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} xmlns="http://www.w3.org/2000/svg" fill="none"
...
@elseif($icon == 'upload-cloud')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} fill="none" stroke="currentColor" viewBox="0 0 24 24"
...
@elseif($icon == 'bars-3')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} mlns="http://www.w3.org/2000/svg" fill="none"
        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
...
@elseif($icon == 'sortable')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} fill="currentColor" viewBox="0 0 20 20"
...
@elseif($icon == 'loyalty')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} viewBox="0 0 24 24" stroke-width="2"
...
@elseif($icon == 'carrot')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} aria-hidden="true" fill="currentColor"
...
@elseif($icon == 'scan-qr')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} fill="currentColor" viewBox="0 0 371.643 371.643"
