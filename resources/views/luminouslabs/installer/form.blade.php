                ...
                <div class="mb-3">
                    ...
                    <div class="w-full flex flex-row items-center justify-between">
                        ...
                        <div class="flex flex-row items-center justify-end">
                            <a href="{{route('luminouslabs::partner.campain.manage')}}" class="w-full flex items-center btn-sm text-sm mr-2 btn-primary ll-primary-btn">
                    ...
                    <form class="ll-user-add-form space-y-4 md:space-y-6" action="{{route('luminouslabs::partner.campain.storge')}}" method="POST" enctype="multipart/form-data" id="CampaignStorge">
                        @csrf
                        ...
                        <div class="mt-4">
                            ...
                            <select class="form-select" required name="card_id"  aria-label="Default select example">
                                ...
                                @foreach ($cards as $card)
                                 <option value="{{$card->id}}">{{$card->name}} - {{$card->unique_identifier }} </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="spinner-form-wrapper">
                        ...
                        <div class="spinner-form">
                            <div class="spinner-fomr-col">
                                <h5>Label Title</h5>
                                <input type="text" name="label_title[]" class="dynamic-input" />
                            </div>
                            <div class="spinner-fomr-col">
                                <h5>Label Value</h5>
                                <input type="text" name="label_value[]" class="dynamic-input" />
                            </div>
                            <div class="spinner-fomr-col">
                                <h5>Label Color</h5>
                                <input type="color" name="label_color[]" class="dynamic-input" />
                            </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#add-input").on("click", function () {
            ...
            var newInput = '<div class="spinner-form"><div class="spinner-fomr-col"><input type="text" name="label_title[]" class="dynamic-input" /></div><div class="spinner-fomr-col"><input type="text" name="label_value[]" class="dynamic-input" /></div><div class="spinner-fomr-col"><input type="color" name="label_color[]" class="dynamic-input" /></div><button type="button" class="remove-input">Remove</button></div>';
