...
@section('content')
    ...
    <section class="w-full partner-login-page place-self-center mx-auto lg:h-full ll-login-container">
        <div class="grid lg:grid-cols-2 lg:h-full">
            ...
            <div class="ll-login-right flex justify-center items-center py-6 px-4 lg:py-6 sm:px-0">
                <div class="w-full space-y-4 md:space-y-6 max-w-lg xl:max-w-lg p-6">
                    ...
                    <x-forms.messages />
                    <x-forms.form-open class="ll-form-container space-y-4 md:space-y-6" :action="route('member.login.post')" method="POST" />
                    <x-forms.input
                    ...
                    <p class="text-sm font-light ll-text-primary-color">
                        {{ trans('common.registration_text') }} <a href="{{ route('member.register') }}"
                            class="text-link font-semibold">{{ trans('common.registration_link') }}</a>
                    </p>
                </div>
