        ...
        <div class="grid lg:grid-cols-2 lg:h-full">
            ...
            <div class="ll-login-right flex justify-center items-center py-6 px-4 lg:py-6 sm:px-0">
                <div class="w-full space-y-4 md:space-y-6 max-w-lg xl:max-w-lg p-6">
                    ...
                    <x-forms.form-open class="ll-form-container space-y-4 md:space-y-6" :action="route('staff.login.post')" method="POST" />
                    <x-forms.input
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('staff.forgot_password') }}" class="ll-dark-theme-light-blue text-sm font-medium text-primary-600 hover:underline dark:text-primary-500" style="color: #2963FF">{{ trans('common.forgot_password') }}</a>
                    </div>
