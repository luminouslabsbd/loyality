            ...
            <div class="flex items-center mb-4">
                ...
                <div>
                    <div class="flex items-center pl-4">
                        <input id="active_only" type="checkbox" value="true" @if($active_only == 'true') checked @endif name="active_only" class="w-4 h-4 bg-gray-100 border-gray-300 rounded dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600">
